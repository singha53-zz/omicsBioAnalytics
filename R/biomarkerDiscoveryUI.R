          ...
          mainPanel(
            ...
            tabsetPanel(type = "tabs",
              tabPanel("Performance",
                ...
                fluidRow(column(2, ""), column(8, h3("Compare biomarker panels"), plotOutput("delongPvalues")), column(2, "")),
                fluidRow(column(2, ""), column(8, h5("*P-value< 0.05. Predicted probablities across all iterations were averaged for each subject prior to performing the De Long test.")), column(2, ""))
              ),
              tabPanel("Panels",
